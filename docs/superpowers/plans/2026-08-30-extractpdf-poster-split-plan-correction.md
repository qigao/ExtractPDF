...
Plan: `docs/superpowers/plans/2026-08-30-extractpdf-poster-split.md`  
Specs: `docs/superpowers/specs/2026-08-30-extractpdf-poster-split-design.md` and `docs/superpowers/specs/2026-08-30-extractpdf-poster-split-preflight-correction.md`  
...
Where this file conflicts with `2026-08-30-extractpdf-poster-split.md`, this file wins.
...
- `extractpdf_pdf_poster_drop_plan()` frees every annotation `tile_indices` array.
...
```text
existing extractpdf.pdf_outline test remains green with no public behavior change
```
...
```cmake
add_executable(extractpdf_test_pdf_poster_split
...
set_source_files_properties(test_pdf_poster_split.c PROPERTIES
  COMPILE_DEFINITIONS "main=extractpdf_pdf_poster_split_base_main")
...
Later tasks add modules with `target_sources(extractpdf_test_pdf_poster_split PRIVATE ...)` and add fixture compile definitions to the same target. Task 5 adds MuPDF privately for raw assertions:
...
There remains exactly one CTest named `extractpdf.pdf_poster_split`.
...
```text
1. docs/superpowers/specs/2026-08-30-extractpdf-poster-split-design.md
2. docs/superpowers/specs/2026-08-30-extractpdf-poster-split-preflight-correction.md
3. docs/superpowers/plans/2026-08-30-extractpdf-poster-split.md
4. docs/superpowers/plans/2026-08-30-extractpdf-poster-split-plan-correction.md
```
