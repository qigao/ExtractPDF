# QuantaPDF CropBox V1 Matrix Correction Plan

> **For agentic workers:** This is a normative correction checkpoint inside the existing inline execution of `docs/superpowers/plans/2026-08-29-quantapdf-cropbox-transform.md`. Do not resume production changes until the correction spec is approved.
...
**Correction Spec:** `docs/superpowers/specs/2026-08-29-quantapdf-cropbox-transform-matrix-correction.md`
